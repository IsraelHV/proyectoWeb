          ...
          <div class="col s12 m9 offset-m3">
            ...
            <table class="highlight centered responsive-table" id="table">
                ...
                <tbody>
                    ...
                    <?php foreach ($link->query('SELECT * FROM alumno INNER JOIN genero ON alumno.genero = genero.id_genero ORDER BY nombre, apellido_Paterno,apellido_Materno;') as $row){  // aca puedes hacer la consulta e iterarla con each. ?>
