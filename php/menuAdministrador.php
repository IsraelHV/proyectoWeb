<?php
    ...
    $consulta= ("SELECT * FROM administrador WHERE (boleta_PA='$no_boletaA' AND contrasena='$contrasena');");
      ...
      <nav class="cyan darken-4" role="navigation">
        ...
        <div class="nav-wrapper container" id="nav-wrapper-administrador">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <!-- Dropdown Trigger -->
            <li><a class="dropdown-trigger cyan-text text-accent-2" href="./salirA.php" data-target="dropdown1">Cerrar Sesión<i class="material-icons right">arrow_back</i></a></li>
