        ...
        <div class="col s12 m9 offset-m3">
          ...
          <table class="highlight centered responsive-table">
            ...
            <tbody>
                ...
                <?php foreach ($link->query("SELECT * FROM alumno INNER JOIN genero ON alumno.genero = genero.id_genero INNER JOIN alcaldia ON alumno.alcaldia = alcaldia.id_alcaldia INNER JOIN escuela ON alumno.escuela_IPN = escuela.id_escuela INNER JOIN entidad_federativa ON alumno.entidad_Federativa = entidad_federativa.id_entidadFederativa INNER JOIN opcion ON alumno.opcion=opcion.id_opcion INNER JOIN laboratorio ON alumno.horario=laboratorio.id_laboratorio INNER JOIN horario ON laboratorio.horario=horario.id_horario WHERE (No_Boleta='$No_Boleta' && correo_Electronico ='$correoElectronico');") as $row){  // aca puedes hacer la consulta e iterarla con each. ?>
                    ...
                    <tr>
                        <th>Alcaldía</th>   
                        <th><?php echo $row['nombreAlcaldia']; ?></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th><?php echo $row['telefono_Celular']; ?></th>
                    </tr>
