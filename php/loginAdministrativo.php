...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          ...
          <h4 class="header col s12 blue-grey-text text-darken-4">Personal Administrativo de la ESCOM</h4>
        </div>
    ...
    <div class="parallax"><img src=".././Imagenes/fondo5.jpg" alt="Unsplashed background img 1"></div>
  ...
  <div class="container row center">
    ...
    <form class="" id="formularioLoginA" action="./validaA.php" method="POST">
        ...
        <div class="col s12 m8 offset-m2 l6 offset-l3 z-depth-3" id="contenedorform">
            ...
            <div class="col s12 m12" id="margen">
                ...
                <div class="row center">
                    ...
                    <input placeholder="Boleta de Personal Administrativo" id="no_boletaA" type="text" class="validate" name="no_boletaA">
                    <label for="no_boletaA">Boleta de Personal Administrativo:</label>
                ...
                <div class="row center">
                    <div class="input-field">
                        ...
                        <input placeholder="Contraseña de Personal Administrativo" id="contrasena" type="password" class="validate" name="contrasena">
                        <label for="contrasena">Contraseña de Personal Administrativo: </label>
                        <span class="helper-text" data-error="Contraseña Incorrecta" data-success="Contraseña Correcta">Contraseña con 10 dígitos</span>
                    </div>
                </div>
