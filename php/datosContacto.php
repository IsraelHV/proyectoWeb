          ...
          <div class="col s12 m9 offset-m3">
            ...
            <table class="highlight centered responsive-table" id="table">
                ...
                <tbody>
                    ...
                    <?php foreach ($link->query('SELECT * FROM alumno INNER JOIN alcaldia ON alumno.alcaldia = alcaldia.id_alcaldia ORDER BY No_Boleta;') as $row){  // aca puedes hacer la consulta e iterarla con each. ?>
