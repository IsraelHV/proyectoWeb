          ...
          <div class="col s12 m9 offset-m3">
            ...
            <table class="highlight centered responsive-table" id="table">
                ...
                <thead>
                    <tr>
                        <th>No. de Boleta</th>
                        <th>Nombre de Escuela IPN</th>
                        <th>Nombre de Escuela No Perteneciente a IPN</th>
                        <th>Entidad</th>
                        <th>Promedio</th>
                        <th>ESCOM fue</th>
                        <th>BORRAR</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($link->query('SELECT * FROM alumno INNER JOIN escuela ON alumno.escuela_IPN = escuela.id_escuela INNER JOIN entidad_federativa ON alumno.entidad_Federativa = entidad_federativa.id_entidadFederativa INNER JOIN opcion ON alumno.opcion=opcion.id_opcion ORDER BY No_Boleta;') as $row){  // aca puedes hacer la consulta e iterarla con each. ?>
                        
                        <tr>
                          <th><?php echo $row['No_Boleta'];?></th>
                          <th><?php echo $row['nombreEscuela']; ?></th>
                          <th><?php echo $row['escuela_NoIPN']; ?></th>
                          <th><?php echo $row['nombreEntidad']; ?></th>
                          <th><?php echo $row['promedio']; ?></th>
                          <th><?php echo $row['nombre_Opcion']; ?></th>
